...
final class ChatImageView: UIView, ContainerCollectionViewCellDelegate {
...
//    }
    ...
    @objc func openAction(_ sender: UIStackView) {
        controller.open()
    ...
    private func setupSubviews() {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(openAction))
    ...
    private func setupSize() {
        UIView.performWithoutAnimation {
            ...
            case let .image(image):
                ...
                let maxWidth = min(viewPortWidth * ChatConstants.maxWidth, image.size.width)
