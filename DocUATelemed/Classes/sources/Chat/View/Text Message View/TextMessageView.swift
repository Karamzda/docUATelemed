...
//    }
    ...
    func reloadData() {
        ...
        let color = (!controller.type.isIncoming && Appearence == .patient) ? UIColor.white : UIColor.black
        UIView.performWithoutAnimation {
            ...
            textView.linkTextAttributes = lineattribute
        }
    }
    ...
    private func setupSubviews() {
        ...
        textView.font = CustomFonts.Style.suisseIntlBook.font(size: 15)
    ...
    private func setupSize() {
        UIView.performWithoutAnimation {
            self.textViewWidthConstraint?.constant = viewPortWidth * ChatConstants.maxWidth
            setNeedsLayout()
        }
    }
